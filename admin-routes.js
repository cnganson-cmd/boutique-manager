...
async function setStockRoute(typeId,sourceId,destinationId,active){
  if(!isAppAdmin())return;
  const button=event?.currentTarget;if(button){button.disabled=true;button.textContent='Enregistrement…'}
  try{
