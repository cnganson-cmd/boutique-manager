...
async function adminSaveProduct(){
  ...
  try{
    ...
    shell(`<div class="success"><div>✓</div><h1>Produit créé</h1><p>${esc(brand)} · ${esc(name)} est maintenant disponible dans le catalogue.</p><button class="primary" onclick="adminCatalog()">Retour au catalogue</button></div>`);
